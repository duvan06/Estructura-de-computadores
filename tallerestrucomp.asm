...
main:
    ...
    blt $t1, $t3, check_second #Aquí comparamos el segundo numero ingresado que está almacenado en $t1 con el primero que está almacenado en $t3
    move $t3, $t1 # si el segundo número es menor, lo almacenamos en $t3
    
    blt $t2, $t3, find_min  #aquí comparamos el tercer número ingresado almacenado con el que está almacenado en $t3 y si $t2 es menor, lo almacenamos en $t3
    j print_result
    

# en éste bloque compararmos entre si los numeros indicados por el usuario y el menor de todos, lo almacenamos en $t3 
...
print_result:
    ...
    li $v0, 1
    move $a0, $t3 #mostramos el mensaje contenido en "resultado" incluyendo el número menor almacenado en $t3
    syscall
